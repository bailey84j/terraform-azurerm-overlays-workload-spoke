...
For more information on Azure Government Cloud, see the [Azure Government](https://docs.microsoft.com/en-us/azure/azure-government/documentation-government-get-started) documentation.
...
Spoke Networking is set up in a Workload Spoke Overlay design based on the SCCA Hub/Spoke architecture. The Workload Spoke Overlay is a central point of connectivity to many different networks.
...
Workload Spoke Overlay has optional features that can be enabled by setting parameters on the deployment.
